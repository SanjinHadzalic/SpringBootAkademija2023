...
public class FlightSearchController {
    ...
    public ResponseEntity<List<FlightSearchResultDto>> searchFlights(@RequestBody @Valid FlightSearchForm flightSearchForm){
        ...
        List<FlightSearchResultDto> flightSearchResultDtosList=amadeusService.searchFlights(flightSearchForm.getOriginLocationCode(),
        ...
        return ResponseEntity.ok().body(flightSearchResultDtosList);
        }
}
